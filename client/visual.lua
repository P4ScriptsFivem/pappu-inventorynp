...
RegisterNetEvent('pappuemo-inventorynp:setDropVisualData', function(data)
    droppedItems = data
end)

RegisterNetEvent('pappuemo-inventorynp:updateDropVisualData', function(dropId, coords, itemsTable)
